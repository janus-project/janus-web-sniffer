...
if (typeof(Timestamp) != "undefined"){
    ...
    console.log("warning: no Timestamp class");
}
...
if (typeof(DBPointer) != "undefined"){
    ...
    console.log("warning: no DBPointer");
}
...
if (typeof(BinData) != "undefined"){
    ...
    console.log("warning: no BinData class");
}
...
if (typeof(gc) == "undefined"){
    gc = function(){
        console.log("warning: using noop gc()");
    };
}
